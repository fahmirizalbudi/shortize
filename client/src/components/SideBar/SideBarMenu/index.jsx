const SideBarMenu = ({ isActive, Icon, navigate, title, onSelectedMenu }) => {
    return (
        <a href={navigate} className={`w-full h-14 rounded p-5 opacity-50 flex gap-4 items-center ${isActive === title && `bg-[#534FEB] opacity-100 text-white`}`} onClick={onSelectedMenu}>
